...
*You might also like [Awesome Django](https://github.com/wsvincent/awesome-django) ⭐ 11,221 | 🐛 10 | 🌐 Python | 📅 2026-08-18 and [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 316,704 | 🐛 18 | 🌐 Python | 📅 2026-08-25. :snake:*
...
* [GitHub repository](https://github.com/wagtail/wagtail) ⭐ 20,466 | 🐛 1,012 | 🌐 Python | 📅 2026-08-28
...
* [Wagtail Terms](https://github.com/smark-1/wagtailterms) ⭐ 9 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - A plugin to add a glossary terms entity to the Draftail editor.
* [wagtailmdx](https://github.com/julinodev/wagtailmdx) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-27 - A [MDXEditor](https://github.com/mdx-editor/editor) ⭐ 3,647 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-27 integration for Wagtail as textfield widget.

### Widgets

* [wagtail-markdown](https://github.com/torchbox/wagtail-markdown) ⭐ 218 | 🐛 10 | 🌐 Python | 📅 2026-08-25 - Markdown support for Wagtail.
...
* [wagtail-autocomplete](https://github.com/wagtail/wagtail-autocomplete) ⭐ 130 | 🐛 52 | 🌐 Python | 📅 2026-08-26 - Autocompleting choosers for `ForeignKey`, `ParentalKey`, and `ManyToMany` fields.
* [wagtail-generic-chooser](https://github.com/wagtail/wagtail-generic-chooser) ⭐ 116 | 🐛 15 | 🌐 Python | 📅 2026-08-26 - provides base classes for building chooser popups and form widgets for the Wagtail admin, matching the look and feel of Wagtail's built-in choosers for pages, documents, snippets and images.
* [wagtailgmaps](https://github.com/springload/wagtailgmaps) ⭐ 85 | 🐛 11 | 🌐 Python | 📅 2025-06-17 - Simple Google Maps address formatter for Wagtail fields.
...
* [wagtail-instance-selector](https://github.com/ixc/wagtail-instance-selector) ⭐ 53 | 🐛 8 | 🌐 Python | 📅 2026-07-05 - A `ForeignKey` widget to create and select related items. Similar to Django's `raw_id_fields`.
...
* [wagtail-html-editor](https://github.com/kkm-horikawa/wagtail-html-editor) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-27 - Enhanced HTML editor block for Wagtail CMS with CodeMirror 6, syntax highlighting, Emmet support, and fullscreen mode.

### StreamField

* [Wagtail Code Block](https://github.com/wagtail-nest/wagtailcodeblock) ⭐ 172 | 🐛 6 | 🌐 Python | 📅 2026-05-02 - StreamField code blocks for the Wagtail CMS with real-time PrismJS Syntax Highlighting.
* [wagtail-inventory](https://github.com/cfpb/wagtail-inventory) ⭐ 64 | 🐛 2 | 🌐 Python | 📅 2026-07-30 - Search Wagtail pages by the StreamField blocks they contain.

### Static site generation

* [Wagtail-bakery](https://github.com/wagtail-nest/wagtail-bakery) ⭐ 194 | 🐛 21 | 🌐 Python | 📅 2026-05-03 - A set of helpers for baking your Django Wagtail site out as flat files.

### Settings management

* [Wagtail-Flags](https://github.com/cfpb/wagtail-flags) ⭐ 91 | 🐛 3 | 🌐 Python | 📅 2026-04-27 - Feature flags for Wagtail sites.

### E-commerce

* [django-salesman](https://github.com/dinoperovic/django-salesman) ⭐ 420 | 🐛 11 | 🌐 Python | 📅 2025-09-24 - Headless e-commerce framework for Django with Wagtail modeladmin integration.

### SEO and SMO

* [Wagtail SEO](https://github.com/coderedcorp/wagtail-seo) ⭐ 93 | 🐛 13 | 🌐 Python | 📅 2025-07-11 - Search engine and social media optimization for Wagtail.
...
* [Wagtail Yoast](https://github.com/Aleksi44/wagtailyoast) ⭐ 36 | 🐛 4 | 🌐 Python | 📅 2026-07-29 - A tool to improve readability of your texts with SEO recommendations.

### Customer experience

* [Wagtail Personalisation](https://github.com/wagtail-nest/wagtail-personalisation) ⭐ 130 | 🐛 43 | 🌐 Python | 📅 2026-08-13 - Personalisation module, enabling editors to create customised pages - or parts of pages - based on segments whose rules are configured directly in the admin interface.
* [Wagtail Experiments](https://github.com/torchbox/wagtail-experiments) ⭐ 108 | 🐛 9 | 🌐 Python | 📅 2025-12-16 – A/B testing for Wagtail.

### Security

* [wagtail-2fa](https://github.com/labd/wagtail-2fa) ⭐ 96 | 🐛 25 | 🌐 Python | 📅 2026-05-27 - Add two-factor authentication to Wagtail by integrating it with django-otp.

### Media

* [wagtailmedia](https://github.com/torchbox/wagtailmedia) ⭐ 252 | 🐛 31 | 🌐 Python | 📅 2026-08-24 - A Wagtail module for managing video and audio files within the admin.
...
* [Wagtail Localize](https://github.com/wagtail/wagtail-localize) ⭐ 255 | 🐛 179 | 🌐 Python | 📅 2026-08-21 - Translation plugin for Wagtail CMS.
* [Wagtail Modeltranslation](https://github.com/infoportugal/wagtail-modeltranslation) ⭐ 153 | 🐛 29 | 🌐 Python | 📅 2026-02-03 - Simple app containing a mixin model that integrates [django-modeltranslation](https://github.com/deschler/django-modeltranslation) ⭐ 1,481 | 🐛 129 | 🌐 Python | 📅 2026-04-14 into Wagtail panels system.

### Forms

* [Wagtail ReCaptcha](https://github.com/wagtail-nest/wagtail-django-recaptcha) ⭐ 63 | 🐛 14 | 🌐 Python | 📅 2026-05-06 - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha](https://github.com/django-recaptcha/django-recaptcha) ⭐ 1,036 | 🐛 25 | 🌐 Python | 📅 2026-08-17 field when using the Wagtail formbuilder.
* [Wagtail Model Forms](https://github.com/vicktornl/wagtail-model-forms) ⭐ 11 | 🐛 5 | 🌐 Python | 📅 2026-06-29 - The Wagtail Form Builder functionalities available for your models/snippets.
...
* [Wagtail Factories](https://github.com/wagtail/wagtail-factories) ⭐ 113 | 🐛 20 | 🌐 Python | 📅 2026-06-04 - Factory boy classes for Wagtail.
...
* [Wagtail-TreeModelAdmin](https://github.com/cfpb/wagtail-treemodeladmin) ⭐ 53 | 🐛 3 | 🌐 Python | 📅 2026-04-10 - An extension for Wagtail's ModelAdmin for a page explorer-like navigation of Django model relationships.
...
* [Wagtail Transfer](https://github.com/wagtail/wagtail-transfer) ⭐ 109 | 🐛 46 | 🌐 Python | 📅 2026-02-07 - An official extension for Wagtail allowing content to be transferred between multiple instances of a Wagtail project
* [Wagtail Sharing](https://github.com/cfpb/wagtail-sharing) ⭐ 56 | 🐛 5 | 🌐 Python | 📅 2026-04-24 – Easier sharing of Wagtail drafts.
* [Wagtail Content Import](https://github.com/torchbox/wagtail-content-import) ⭐ 37 | 🐛 7 | 🌐 Python | 📅 2026-08-24 - Import content from Google Docs or Docx into StreamFields, using a customisable mapping system.
...
* [Wagtail Grapple](https://github.com/torchbox/wagtail-grapple) ⭐ 160 | 🐛 62 | 🌐 Python | 📅 2026-07-06 - A Wagtail app that makes building GraphQL endpoints a breeze.
...
* [Wagtail Cache](https://github.com/coderedcorp/wagtail-cache) ⭐ 90 | 🐛 8 | 🌐 Python | 📅 2025-07-09 - A simple page cache for Wagtail using the Django cache middleware.
...
* [Wagtail App Pages](https://github.com/mwesterhof/wagtail_app_pages) ⭐ 33 | 🐛 4 | 🌐 Python | 📅 2026-07-08 - Extend Wagtail pages using an actual URL config and django views.
...
* [Pipit](https://github.com/Frojd/Wagtail-Pipit) ⭐ 257 | 🐛 43 | 🌐 Python | 📅 2026-08-20 – Pipit is a Wagtail CMS boilerplate which aims to provide an easy and modern developer workflow with a React-rendered frontend.
* [Sites Conformes](https://github.com/numerique-gouv/sites-conformes) ⭐ 67 | 🐛 46 | 🌐 Python | 📅 2026-08-28 - Gestionnaire de contenu permettant de créer et gérer un site internet basé sur le Système de design de l'État, accessible et sécurisé. Basé sur Wagtail CMS.
* [cookiecutter-wagtail-vix](https://github.com/engineervix/cookiecutter-wagtail-vix) ⭐ 40 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - a minimal, batteries-included, reusable project skeleton to serve as a starting point for a Wagtail project.
* [cookiecutter-wagtail-package](https://github.com/wagtail/cookiecutter-wagtail-package) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - A cookiecutter template for building Wagtail add-on packages.
...
* [Wagtail News Template](https://github.com/wagtail/news-template) ⭐ 185 | 🐛 69 | 🌐 Python | 📅 2026-08-23 - A Wagtail template for a news site.
...
* [SEO dashboard – Wagtail Space 2019](https://www.youtube.com/watch?t=3937\&v=CSwpj-jyjP4) by Janneke Janssen. [Code](https://github.com/LUKKIEN/wagtail-marketing-addons) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2026-07-15.
...
* [Wagtail demo project](https://github.com/wagtail/bakerydemo) ⭐ 1,080 | 🐛 60 | 🌐 Python | 📅 2026-08-28 – Next generation Wagtail demo, born in Reykjavík.
* [consumerfinance.gov](https://github.com/cfpb/consumerfinance.gov) ⭐ 332 | 🐛 41 | 🌐 Python | 📅 2026-08-28 – Django project protecting American consumers.
* [Outreachy website](https://github.com/outreachy/website) ⭐ 306 | 🐛 214 | 🌐 HTML | 📅 2026-08-21 - Code for the Outreachy website, based on Python, Django, and Bootstrap.
* [Federal Election Commission](https://github.com/fecgov/fec-cms) ⭐ 107 | 🐛 486 | 🌐 Python | 📅 2026-08-26 – The content management system (CMS) for the new Federal Election Commission website.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop.org) ⭐ 45 | 🐛 57 | 🌐 Python | 📅 2026-08-28 – Wagtail-powered website of the SecureDrop whistleblower document submission system.
* [Wagtail user guide](https://github.com/wagtail/guide) ⭐ 36 | 🐛 54 | 🌐 Python | 📅 2026-08-26 - A website to teach Wagtail to content editors, moderators and administrators.
...
* [Torchbox.com on Wagtail](https://github.com/torchbox/torchbox.com) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-08-26 – Torchbox website 2024 incarnation.
* [Penticon Public Library](https://github.com/danlerche/public-library-wagtailCMS) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-03 - This is an example public library website using wagtail CMS.
